...
from clinica.models import (Diagnostico, DepartamentoMunicipio, ComunidadEtnia, Pais, Triage, Ocupacion,
                            ...
                            OpocisionDonacion, VoluntaAnticipada, Usuario, UsuarioPais, UsuarioDiscapacidad,
...
class UsuarioAdmin(admin.ModelAdmin):
    list_display = ["primer_nombre", "segundo_nombre", "primer_apellido", "segundo_apellido", "tipo_documento",
                    "numero_documento", "nacionalidad", "fecha_nacimiento", "entidad"]
